...
void usage(void)
{
    ...
    fprintf(stderr,
        ...
        "       specified folder.\n"
        "   --ignore-assets\n"
        "       Assets to be ignored. Default pattern is: %s\n"
...
int handleCommand(Bundle* bundle)
{
    ...
    case kCommandVersion:      return bundle->getFileSpecCount();
    case kCommandList:         return bundle->getFileSpecCount();
    case kCommandDump:         return bundle->getFileSpecCount();
    case kCommandAdd:          return bundle->getFileSpecCount();
    case kCommandRemove:       return bundle->getFileSpecCount();
    case kCommandPackage:      return bundle->getFileSpecCount();
    case kCommandCrunch:       return bundle->getFileSpecCount();
    case kCommandSingleCrunch: return bundle->getFileSpecCount();
    case kCommandDaemon:       return bundle->getFileSpecCount();
